...
void MetaCartridge::display_meta() {
	std::cout << std::left << std::setw(25) << "Game Title: " << std::setw(25)
	          << title << std::endl;
    std::cout << std::left << std::setw(25) << "Color GameBoy Support: " << std::setw(25)
    ...
    std::cout << std::left << std::setw(25) << "Cartridge Type: " << std::setw(25)
              << cartridge_type_parse.at(cartridge_type) << std::endl;
    std::cout << std::left << std::setw(25) << "Cartridge ROM Size: " << std::setw(25)
              << rom_size_parse.at(rom_size) << std::endl;
    std::cout << std::left << std::setw(25) << "Super GameBoy Support: " << std::setw(25)
              << sgb_flag_parse.at(sgb_flag) << std::endl;
    std::cout << std::left << std::setw(25) << "External Cartridge RAM: " << std::setw(25)
