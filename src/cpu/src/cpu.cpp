...
CPU::CPU(memory::MemoryInterface *memory)
	...
	// clang-format off
	auto opcode_map = new std::vector<std::function<void()>> {
	    /* 0x00 */ [=] { op_nop(); },
	    ...
	    /* 0x1f */ [=] { op_rr_a(); },
	    /* 0x20 */ [=] { op_jr(!f->get_bit(FLAG_ZERO), get_inst_byte()); },
	    ...
	    /* 0x27 */ [=] { op_daa(); },
	    /* 0x28 */ [=] { op_jr(f->get_bit(FLAG_ZERO), get_inst_byte()); },
	    ...
	    /* 0x2f */ [=] { op_cpl(); },
	    /* 0x30 */ [=] { op_jr(!f->get_bit(FLAG_CARRY), get_inst_byte()); },
	    ...
	    /* 0x37 */ [=] { op_scf(); },
	    /* 0x38 */ [=] { op_jr(f->get_bit(FLAG_CARRY), get_inst_byte()); },
	    ...
	    /* 0xbf */ [=] { op_cp(a->get()); },
	    /* 0xc0 */ [=] { op_ret(!f->get_bit(FLAG_ZERO)); },
	    /* 0xc1 */ [=] { op_pop(bc.get()); },
	    /* 0xc2 */ [=] { op_jr(!f->get_bit(FLAG_ZERO), get_inst_dbl()); },
	    /* 0xc3 */ [=] { op_jp(get_inst_dbl()); },
	    /* 0xc4 */ [=] { op_call(!f->get_bit(FLAG_ZERO), get_inst_dbl()); },
	    /* 0xc5 */ [=] { op_push(bc.get()); },
	    /* 0xc6 */ [=] { op_add(get_inst_byte()); },
	    /* 0xc7 */ [=] { op_rst(0x00); },
	    /* 0xc8 */ [=] { op_ret(f->get_bit(FLAG_ZERO)); },
	    /* 0xc9 */ [=] { op_ret(); },
	    /* 0xca */ [=] { op_jr(f->get_bit(FLAG_ZERO), get_inst_dbl()); },
	    /* 0xcb */ [=] { /* CB Opcodes handled separately */ },
	    /* 0xcc */ [=] { op_call(f->get_bit(FLAG_ZERO), get_inst_dbl()); },
	    /* 0xcd */ [=] { op_call(get_inst_dbl()); },
	    /* 0xce */ [=] { op_adc(get_inst_byte()); },
	    /* 0xcf */ [=] { op_rst(0x08); },
	    /* 0xd0 */ [=] { op_ret(!f->get_bit(FLAG_CARRY)); },
	    /* 0xd1 */ [=] { op_pop(de.get()); },
	    /* 0xd2 */ [=] { op_jr(!f->get_bit(FLAG_CARRY), get_inst_dbl()); },
	    /* 0xd3 */ [=] { /* UNDEFINED */ },
	    /* 0xd4 */ [=] { op_call(!f->get_bit(FLAG_CARRY), get_inst_dbl()); },
	    /* 0xd5 */ [=] { op_push(de.get()); },
	    /* 0xd6 */ [=] { op_sub(get_inst_byte()); },
	    /* 0xd7 */ [=] { op_rst(0x10); },
	    /* 0xd8 */ [=] { op_ret(f->get_bit(FLAG_CARRY)); },
	    /* 0xd9 */ [=] { op_reti(); },
	    /* 0xda */ [=] { op_jr(f->get_bit(FLAG_CARRY), get_inst_dbl()); },
	    /* 0xdb */ [=] { /* UNDEFINED */ },
	    /* 0xdc */ [=] { op_call(f->get_bit(FLAG_CARRY), get_inst_dbl()); },
	    /* 0xdd */ [=] { /* UNDEFINED */ },
	...
	// Initialize CB opcode map
	auto cb_opcode_map = std::vector<std::function<void()>>{
	    /* 0x00 */ [=] { op_rlc(b.get()); },
	    /* 0x01 */ [=] { op_rlc(c.get()); },
	    /* 0x02 */ [=] { op_rlc(d.get()); },
	    /* 0x03 */ [=] { op_rlc(e.get()); },
