...
void DoubleRegister::set(uint16_t value) {
    _value = value;
}
...
uint16_t DoubleRegister::get() const {
    return _value;
}
...
void DoubleRegister::operator++() {
    _value++;
}

void DoubleRegister::operator++(int) {
    _value++;
}
...
// PairRegister
PairRegister::PairRegister(Register* first, Register* second)
...
void PairRegister::operator++() {
    this->set(this->get() + 1);
}

void PairRegister::operator++(int) {
    this->set(this->get() + 1);
}
